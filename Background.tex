...
%\noindent{\bf Retrieval models.} Our work relies in the definitions of \textbf{scope} and \textbf{verbosity} hypotheses as well as the \textbf{Probability of Relevance Framework (PRF)} which are defined as follows.\\
...
%
%Results from TREC tracks
%
%- Morphology of MBs make them difficult to retrieve.\\
%- Researchers blame DL and TF, \\
%- Little or no understanding of how RM's interact with these features MB.\\
%- And even less how can we make it better\\
